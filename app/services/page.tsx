...
import { CheckCircle2, Shield, CreditCard, Clock } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="rounded-2xl border p-6 md:p-8 shadow-sm bg-white">
            ...
            <p className="mt-3 text-gray-700">
              We configure key settings, chart of accounts sanity check, connect banks/feeds, and
              deliver a clean onboarding review so you start from solid ground.
            </p>
            <ul className="mt-6 space-y-2 text-gray-700">
              <li className="flex gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
                Chart of Accounts review &amp; clean-up recommendations
              </li>
              <li className="flex gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
                Bank feed connections &amp; settings validation
              </li>
              <li className="flex gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
                Opening balances &amp; basic workflows
              </li>
              <li className="flex gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
                1:1 handoff call with action items
              </li>
            </ul>
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <PurchaseButton
                label="Buy QuickBooks Set Up — $297"
                productKey="qbo-setup"
                icon={CreditCard}
              />
              <PurchaseButton
                label="Buy New Customer Onboarding Review — $149"
                productKey="onboarding-review"
                icon={CreditCard}
              />
            </div>
            <p className="mt-3 text-sm text-gray-500">
              Secure checkout via Stripe. One-time payments.
            </p>
          </div>
          ...
          <div className="rounded-2xl border p-6 md:p-8 shadow-sm bg-white">
            ...
            <p className="mt-3 text-gray-700">
              ...
              <strong>$84/month</strong>, billed automatically. Must cancel at least{" "}
              <strong>10 days</strong> prior to your next billing date.
            </p>
            <ul className="mt-6 space-y-2 text-gray-700">
              <li className="flex gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
                30-point review covering bank recs, categorizations, aging, and more
              </li>
              <li className="flex gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
                2-page feedback report with fixes &amp; priorities
              </li>
              <li className="flex gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-600" />
                Turnaround aimed for within 5 business days
              </li>
            </ul>
            <div className="mt-8 space-y-3">
              ...
              <p className="text-sm text-gray-500">
                Approval required. We don’t accept subscriptions until your books are in workable
                shape.
              </p>
            </div>
          </div>
      ...
      <section id="confidence-check-apply" className="bg-gray-50 border-t">
        <div className="container mx-auto px-4 py-16">
          ...
          <p className="mt-3 text-gray-700 max-w-2xl">
            Tell us a bit about your current QuickBooks setup. If approved, we’ll send an invite to
            activate your $84/month Confidence Check subscription.
          </p>
          <div className="mt-8 rounded-2xl bg-white p-6 md:p-8 shadow-sm">
            ...
            <p className="mt-4 text-sm text-gray-500">
              ...
              <Link href="https://calendly.com/simplifibooks2025/30min" className="underline">
